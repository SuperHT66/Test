   ...
   public class CEUtil
    {
        ...
        /// <returns></returns>
        public static IDocument CreateDocumentZ050(bool withContent, String file, String mimeType, String docName, IObjectStore os, String className, Z050Info info)
        {
            IDocument doc = null;
            if (className.Equals(""))
                doc = Factory.Document.CreateInstance(os, null);
            ...
            IStringList list = Factory.StringList.CreateList();
            list.Add(info.SYS_ID);

            doc.Properties["DocumentTitle"] = docName;
            doc.Properties["MAT_CODE"] = info.MAT_CODE;
            doc.Properties["MAT_NAME"] = info.MAT_NAME;
            doc.Properties["SYS_ID"] = list;
            Type t1 = doc.Properties["SYS_ID"].GetType();
            doc.Properties["REL_TIME"] = info.REL_TIME;
            doc.Properties["IS_SPEC"] = info.IS_SPEC;
            Type t2 = doc.Properties["IS_SPEC"].GetType();      
            doc.Properties["FRE_IDE"] = info.FRE_IDE;
            doc.Properties["DEL_DATA"] = info.DEL_DATA;
            doc.Properties["QUA_EXC"] = info.QUA_EXC;
            doc.Properties["MAT_CLA_CODE"] = info.MAT_CLA_CODE;
            doc.Properties["MAT_MAINCATEGORIES"] = info.MAT_MAINCATEGORIES;
            doc.Properties["MAT_MIDCATEGORIES"] = info.MAT_MIDCATEGORIES;
            doc.Properties["MAT_SUBCATEGORIES"] = info.MAT_SUBCATEGORIES;
            doc.Properties["MAT_COMMODITYNAME"] = info.MAT_COMMODITYNAME;
